...
import com.gonggu.pay.exception.PayException;
import com.gonggu.pay.response.ErrorResponse;
...
public class ExceptionController {
    ...
    public ResponseEntity<ErrorResponse> boardException(PayException e) {
